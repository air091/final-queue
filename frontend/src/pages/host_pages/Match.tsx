          ...
          <div className="sticky top-2 z-40 flex w-full flex-none flex-col self-start rounded-3xl border border-orange-100 bg-white p-3 shadow-sm max-h-[45dvh] md:h-[calc(100dvh-5rem)] md:max-h-[calc(100dvh-5rem)] md:w-[346px] md:p-4 min-[1321px]:w-[clamp(420px,34vw,760px)]">
            <header className="mb-3 min-[1280px]:mb-4">
              <div className="">
                ...
                <div className="mt-3">
                  <div className="relative flex items-center gap-2 rounded-2xl border border-orange-100 bg-orange-50 px-3 py-2">
            ...
            <main
              className="
                ...
                grid-cols-1
                min-[856px]:grid-cols-2 py-3 px-5
                min-[481px]:grid-cols-2
                min-[1025px]:grid-cols-2
                min-[1201px]:grid-cols-2
                min-[1280px]:py-3
                min-[1280px]:px-4
                min-[1280px]:gap-3
              "
                ...
                <section className="mt-6 border-t border-orange-100 pt-5">
                  ...
                  <div className="grid grid-cols-1 gap-3 min-[1201px]:grid-cols-[repeat(auto-fit,minmax(340px,1fr))]">
                    ...
                    <button
                      ...
                      className="
                    flex h-[120px] w-full items-center justify-center cursor-pointer
                    rounded-2xl border border-dashed border-orange-200
                    bg-orange-50/40 text-sm font-semibold text-stone-500
                    transition-all duration-200
                    hover:border-[var(--color-primary)]
